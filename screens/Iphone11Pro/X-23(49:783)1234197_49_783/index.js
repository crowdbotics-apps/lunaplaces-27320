...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_49_784}>
        <View style={styles.View_49_785}>
          <Text style={styles.Text_49_785}>LunaPlaces</Text>
        </View>
        <View style={styles.View_49_786}>
          <Text style={styles.Text_49_786}>Prenota la tua postazione</Text>
        </View>
      </View>
      <View style={styles.View_49_787} />
      <View style={styles.View_49_788} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/9407/1743/b0717e46f66498a6a28d5f4d1ef206b2"
        }}
        style={styles.ImageBackground_49_789}
      />
      <View style={styles.View_49_791}>
        <View style={styles.View_49_792}>
          <Text style={styles.Text_49_792}>Postazione 5</Text>
        </View>
        <View style={styles.View_49_793}>
          <Text style={styles.Text_49_793}>25/05/2021 - Tutto il giorno</Text>
        </View>
      </View>
      <View style={styles.View_49_794}>
        <View style={styles.View_49_795}>
          <Text style={styles.Text_49_795}>Ufficio di Enea</Text>
        </View>
        <View style={styles.View_49_796}>
          <Text style={styles.Text_49_796}>25/05/2021 - 11:30 / 12:30</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_49_797}
      />
      <View style={styles.View_49_799}>
        <Text style={styles.Text_49_799}>Le tue ultime prenotazioni</Text>
      </View>
      <View style={styles.View_49_800}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6612/973f/6ed6d1a4782d81ad8822ac34fe465716"
          }}
          style={styles.ImageBackground_49_801}
        />
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_49_804}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_49_806}
      />
      <View style={styles.View_49_859} />
      <View style={styles.View_49_860}>
        <View style={styles.View_49_861}>
          <Text style={styles.Text_49_861}>Tavolo A - Postazione 1</Text>
        </View>
        <View style={styles.View_49_862}>
          <Text style={styles.Text_49_862}>29/05/2021 - 08:30 - 17:30</Text>
        </View>
      </View>
      <View style={styles.View_49_863}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/6612/973f/6ed6d1a4782d81ad8822ac34fe465716"
          }}
          style={styles.ImageBackground_49_864}
        />
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_49_867}
      />
      <View style={styles.View_49_808} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/cc1b/0000/9f95eefcd6a94ec3ed61200f1327f1ee"
        }}
        style={styles.ImageBackground_49_809}
      />
      <TouchableOpacity
        onPress={() =>
      ...
      >
        <View style={styles.View_49_811}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/9ed5/835c/83a47a57d27344c9c00c5cd3cd889011"
            }}
            style={styles.ImageBackground_49_812}
          />
        </View>
      </TouchableOpacity>
      <TouchableOpacity
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("49_665"))
        }
      >
        <View style={styles.View_49_822}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1e53/3940/66b268dd06df086ca2b66c4b7f110c79"
            }}
            style={styles.ImageBackground_49_823}
          />
        </View>
      </TouchableOpacity>
      <TouchableOpacity
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("49_869"))
        }
      >
        <View style={styles.View_49_826}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/e39a/3cb7/cadff2e5c11f95849bb55b415223eaa8"
            }}
            style={styles.ImageBackground_49_827}
          />
        </View>
      </TouchableOpacity>
      <TouchableOpacity
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("49_933"))
        }
      >
        <ImageBackground
          source={{
          ...
          style={styles.ImageBackground_49_832}
        />
      </TouchableOpacity>
      <View style={styles.View_49_834}>
        <View style={styles.View_I49_834_2419_29805}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/051e/c975/1346880372140925aff0833da6d69565"
            }}
            style={styles.ImageBackground_I49_834_2419_29804}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_I49_834_2419_29806}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_I49_834_2419_29810}
          />
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_I49_834_2419_29814}
          />
        </View>
        <View style={styles.View_I49_834_2419_29821}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1490/2143/45d3baf791104d4bb3c58a581665c5ea"
            }}
            style={styles.ImageBackground_I49_834_2419_29822}
          />
        </View>
      </View>
      <View style={styles.View_49_835}>
        <View style={styles.View_I49_835_2419_29797}>
          <View style={styles.View_I49_835_2419_29798} />
        </View>
      </View>
      <TouchableOpacity
        onPress={() =>
      ...
      >
        <View style={styles.View_49_836}>
          <View style={styles.View_49_837} />
          <View style={styles.View_49_838}>
            <Text style={styles.Text_49_838}>PRENOTA</Text>
          </View>
        </View>
      </TouchableOpacity>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_49_801: {
    width: wp("6.418994140625001%"),
    height: hp("1.777663908369554%"),
    top: hp("0.7530754381190263%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("-0.009114583333333925%")
  },
  ImageBackground_49_804: {
    width: wp("6.4%"),
    height: hp("3.278688524590164%"),
  ...
  ImageBackground_49_864: {
    width: wp("6.418994140625001%"),
    height: hp("1.777663908369554%"),
    top: hp("0.7530754381190228%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("-0.009114583333333925%")
  },
  ImageBackground_49_867: {
    width: wp("8.533333333333333%"),
    height: hp("4.371584699453552%"),
  ...
  ImageBackground_49_827: {
    width: wp("6.40174814860026%"),
    height: hp("2.1823771012936786%"),
    top: hp("0.5481574053321339%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("-0.0026041666666714036%")
  },
  ImageBackground_49_832: {
    width: wp("6.4%"),
    height: hp("3.278688524590164%"),
    top: hp("101.36612021857923%"),
    marginLeft: 0,
  ...
  ImageBackground_I49_834_2419_29804: {
  ...
  ImageBackground_I49_834_2419_29806: {
  ...
  ImageBackground_I49_834_2419_29810: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("62.71822916666666%"),
    top: hp("2.709110447617828%")
  },
  ImageBackground_I49_834_2419_29814: {
    ...
    marginTop: 0,
    position: "absolute",
    left: wp("56.84453124999999%"),
    top: hp("2.755003548710724%")
  },
  View_I49_834_2419_29821: {
    flexGrow: 1,
  ...
  ImageBackground_I49_834_2419_29822: {
    width: wp("14.399999999999999%"),
